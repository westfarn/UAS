...
def circles2(filename='Pictures/test2.jpg'):
    ...
    #print('cimg',cimg)
    #print(type(img))
    circles = cv2.HoughCircles(img, cv2.cv.CV_HOUGH_GRADIENT,1,20,param1=50,param2=30,minRadius=30,maxRadius=40)
    if circles == None:
...
##  
    ...
    if circles is not None and i[2] < 40 and i[2] > 30:
        #print circles
        return True
    else:
        return False
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        filenames = ['Pictures/test_1.jpg','Pictures/test_2.jpg','Pictures/test_3.jpg','Pictures/test_4.jpg','Pictures/test_5.jpg',
                     'Pictures/test_6.jpg','Pictures/test_7.jpg','Pictures/test_8.jpg','Pictures/test_9.jpg','Pictures/test2.jpg']
        for name in filenames:
            result = circles2(name)
            #print(result)
    if result:
        print("Return True")
        sys.exit(1)
